...
const Consigna = () => {
    return (
        <>
            <h1>Practica 3 Obligatoria </h1>
            <p>Nuestro cliente, debido a traumas pasados, está en guerra abierta con todos los usuarios que eligen como nombre de usuario una palabra que contenga la letra o (sea mayúscula o minúscula).
                ...
                Además, en un elemento "Parrafo" abajo del botón, se debe ir visualizando el valor ingresado a medida que el usuario lo ingresa en el input.
                ...
                Recordar buscar por mayúscula y por minúscula. </p>
        </>
    )
}
